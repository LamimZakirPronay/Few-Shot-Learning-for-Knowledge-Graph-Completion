...
class Model_Run(object):
	def __init__(self, arg):
		...
		self.scheduler = optim.lr_scheduler.MultiStepLR(self.optim, milestones=[5000], gamma=0.25)
	...
	def eval(self, mode='test', meta=False):
		...
		#print (len(test_tasks.keys()))
		temp_count = 0
		print (test_tasks.keys())
		test_key_temp = [list(test_tasks.keys())[2]]
		#print test_key_temp
		#for query_ in test_tasks.keys():
		for query_ in test_key_temp:
			#print (query_)
