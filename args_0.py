...
def read_args():
	...
	parser.add_argument("--datapath", default="../data/Wiki", type=str)
	...
	parser.add_argument("--no_meta", default= 1, type=int)
	parser.add_argument("--margin", default=5.0, type=float)
	parser.add_argument("--eval_every", default=10000, type=int)
	parser.add_argument("--max_batches", default=100000, type=int)
	parser.add_argument("--prefix", default='intial', type=str)
	parser.add_argument("--set_aggregator", default="other", type=str)
